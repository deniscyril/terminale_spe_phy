...
\etiquetterouge{Faite attention à} 
	\begin{itemize}
		\item L'enchainement des étapes qui permettent de passer du bilan des force aux équations horaires.
...
\etiquette{Situation} Un soumet deux plaques métalliques séparées d'une distance $d$ à une tension électrique U imposée par un générateur. Entre ces deux plaques apparaît un champ électrique $\vec{E}$.
...
\textbf{Attention} Si $q>0$ la force et le champ électrique sont de même sens mais si $q<0$ la force est de sens opposée à $\vec{E}$.
