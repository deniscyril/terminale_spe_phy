...
Certaines espèces en solutions sont colorées (l'ion permanganate, le diiode, etc). Cette couleur est due à l'absorption de certaines radiations. Le \trou{spectre d'absorption} d'une espèce montre quelles sont les radiations absorbées.
...
\blocrouge{Loi de Beer-Lambert}{Pour une solution de concentration $c$ l'absorbance A vaut $$A=k\times c$$ avec $k$ une constante qui dépend du soluté et de l'épaisseur $\ell$ de la cuve.
...
\etiquetterouge{Important} La loi de Beer-Lambert modélise la relation entre A et c. Ce modèle est bien vérifié lorsque la concentration est inférieure  à $10^{-2}$ mol/L.

\etiquette{Compléments} L'absorbance se calcule à partir de l'intensité lumineuse incidente $I_0$ et l'intensité lumineuse transmise $I_1$ selon $$A = \log{\frac{I_1}{I_0}}$$
\begin{figure*}[htp!]
	\begin{center}
...
\begin{enumerate}
\item A partir de la loi de Kohlrausch,  exprimer la conductivité de la solution en fonction des conductivités molaires ioniques des ions présents.
...
\item Appliquer la loi de Kohlrausch puis exprimer la conductivité de la solution $\sigma$ en fonction des conductivités molaires ioniques des ions présents en solution et de c.\\
...
\etiquetterouge{Important}  La loi de Kohlrausch suppose que la solution ionique est suffisamment diluée ($c<\SI{10e-2}{\mole\per\liter}$) 
