...
\subsection{Relation de Bernouilli}
...
\begin{minipage}{.50\textwidth}
  \begin{itemize}
	...
	\item La relation de Bernouilli exprime la conservation de l'\trou{énergie mécanique} entre A et B.
\end{itemize}
...
\blocrouge{Enoncé de la relation de Bernouilli}{On considère un fluide parfait, incompréssible et en régime permanent.  A et B sont deux points appartenant à une même ligne de courant. On a $$\frac{1}{2}\rho\times  v_A^2 + \rho g z_A + P_A=\frac{1}{2}\rho\times  v_B^2 + \rho g z_B + P_B =cste$$}
...
\begin{minipage}{.45\textwidth}
  On veut appliquer la relation de Bernouilli à l'écoulement ci-contre. On admet que  $S_1 >S_2$.
\end{minipage}
\hfill
\begin{minipage}{.55\textwidth}
...
\begin{enumerate}
	...
	\item Choisir une ligne de courant avec les points A et B tel que $z_A=z_B$.
	\item Ecrire la relation de Bernouilli le long de la ligne  de courant. 
...
\etiquetterouge{Exercices} pages 288 à 295
\begin{itemize}
	\item Poussée d'Archimède: 5 , 18 p 288 
	\item Conservation du débit volumique: 9
	\item Relation de Bernouilli: 2 , 17 , 21 , 25 , prepa ECE p 295
