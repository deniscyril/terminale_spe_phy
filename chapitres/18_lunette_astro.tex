...
\item $OF=OF'$ désigne la distance focale en mètre. $v=\frac{1}{v}$ est la vergence de la lentille en \trou{dioprie noté:$\delta$}
\end{itemize}
\begin{enumerate}
...
\etiquette{Stratégie}
\begin{enumerate}
	\item Calculer $\tan\alpha$ et $\tan\alpha '$ dans un triangle dont un des côtés et $A_1B_1$.
