...
\begin{itemize}
	...
	\item Si l'énergie apportée par le photon est supérieur à $W_{extraction}$ alors l'excédant est \trou{emporté} par l'électron sous forme d'\trou{énergie cinétique}.
...
Un photon d'énergie $Ec=\SI{5.03}{\eV}$ extrait un électron électron depuis un plaque de fer métallique. 
\begin{enumerate}
...
La surface d'un panneau photovoltaïque est constituée de cellule photovoltaïque. Chacune de ces cellules absorbent des photons et par effet photoélectrique produit un \trou{courant}.
...
Dans un appareil photo (camera, téléphone, etc) le capteur est une surface tapissée de photodiodes. Chaque photodiode convertie la lumière reçue en courant électrique grâce à \trou{l'effet photoélectriqu}e.

\subsection{Emission de photon}
\etiquette{DEL Diode ElectroLumindescente}
