...
\end{center}
 L'aptitude d'un condensateur à accumuler sur ses surfaces conductrices un grand nombre de charges électriques est appelée capacité. \\
  La capacité se note C et se mesure en \trou{farad (F)}\\
	...
	\begin{itemize}
		\item Si on augmente la surface des plaques alors \trou{la capacité du condensateur diminue.}
		\item Si on augmente la distance entre les plaques alors  \trou{la capacité du condensateur augmente.}
	\end{itemize}
...
Cette équation a une solution de la forme $u_c(t)=Ke.^{-t/RC}$.\\
$u_c(0)=E=K$ on en déduit que $A=E$\\
...
\etiquetterouge{Objectif} Trouver l'expression mathématique de la tension $u_c(t)$ aux bornes du condensateur pendant sa décharge.\\
...
Cette équation a une solution de la forme $u_c(t)=\trou{Ke.^{-t/RC}+E}$\\
...
\begin{itemize}
	\item On constate qu'après une certaine durée, la tension du condensateur n'évolue plus. On dit que le régime \trou{transitoire} est terminé et que le régime \trou{permanent} et atteint.  
