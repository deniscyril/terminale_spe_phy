...
\begin{enumerate}
	...
	\item Vérifier que l'équation obtenue est équilibrée en terme de d'atomes et de charges.
\end{enumerate}
}
...
\begin{itemize}
	...
	\item Il existe 2 facteurs cinétiques: 
		\begin{enumerate}
			...
			\item \trou{La concentration: Plus la concentration des réactifs est grandes plus la réaction est rapide.}
		\end{enumerate}
\end{itemize}
}
...
Soit R un réactif dont on souhaite connaître la vitesse de disparition. En utilisant le même raisonnement que pour la vitesse d'appartiton, on va calculer s'intéresser à la dérivée de sa concentration $\dfrac{d[R]}{dt}$.
...
\newpage
\section{Temps de temi-réaction}
...
On traçant le graphe de \trou{ln[A] en fonction du temps}
...
\begin{itemize}
	...
	\item Plus la concentration d'un réactif est grande, plus les choc efficaces sont \trou{fréquents}et plus la vitesse est grande.
\end{itemize}
...
\includegraphics[width=13 cm]{figures/cinetique/sites.png}
 \begin{enumerate}
 	\item Identifier le sites donneur et le site accepteur mis en jeu lors de l'acte élémentaire.
