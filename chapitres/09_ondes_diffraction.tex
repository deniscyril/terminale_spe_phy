...
Bien que l'onde se propage, la corde de se déplace pas dans son ensemble. On dit qu'il n'y a pas de transport de matière. 
...
\blocrouge{Vocabulaire}{On appelle retard la durée mis par la perturbation pour aller de $M$ à $M'$ . On dit que le point $M'$ est en \trou{\textbf{retard}} par rapport à $M$. }
...
\blocrouge{Définition}{L'effet Doppler est l'existence d'un décalage entre la fréquence d'une onde émise $f_E$ et la fréquence de l'onde reçue $f_R$ lorsque la distance entre l'émetteur et le un récepteur varie.\\ L'écart de fréquence est appelée: décalage Doppler et vaut $\Delta f=f_R-f_E$}
...
Les raies du spectre d'une étoile qui s'éloigne de la Terre sont perçue décalées en comparaison avec celles mesurées de puis une source immobile. Ce décalage peut être utlisé pour la mesure d'une vitesse d'éloignement. 
