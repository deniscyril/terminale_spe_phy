...
\blocgris{Expérience}{
Lorsqu'on ajoute à $\SI{50,0}{\milli\liter}$ de la solution d'acide éthanoïque de concentration $\SI{1,0e-2}{\mole\per\liter}$ un peu d'ions $\rm CH_3COO^-$ en faisant en sorte que la variation de volume soit négligeable, on constate une augmentation du pH.
}
...
\etiquette{Montage expérimental} Pour réaliser une pile, on utilise des demi-piles. Une demi-pile est formée par l'association d'un métal et d'une solution contenant l'ion métallique.
\begin{center}
\begin{figure}[htp!]
...
\blocrouge{Définition}{La capacité d'une pile, notée Q, est égale à la \trou{charge électrique} qui circule pendant la durée totale de son fonctionnement, de l'état initial à l'usure complète. La capacité de la pile s'exprime en \trou{coulomb (C)}. \\ Rien à voir avec le quotient réactionnel Qr !!
}
...
$\Delta t$ la durée de vie de la pile en secondes (s)
\end{center}
