...
\begin{itemize}
	...
	\item la taille des particules est négligeables
\end{itemize}
...
\begin{itemize}
	...
	\item Vous frotter vigoureusement vos mains entre elles, les forces de frottements travaillent et cette énergie reçue augmente l'énergie interne de vos mains et ainsi leurs températures.
...
\begin{itemize}
	...
	\item Calculer la sommes des transferts : W + Q 
...
Identifier les grandeurs qui influe sur la variation de température d'un système qui reçoit un transfert thermique Q.
\begin{center}
...
\etiquette{Remarque} Lors de cette transformation, l'énergie énergie interne varie. D'après le premier principe on a $\Delta U = Q$ car $W=0$ (incompressible).
...
La capacité thermique d'un litre d'eau est 4180 J/K. Cela signifie qu'en transférant une énergie Q= 4180 J à un litre d'eau, on augmente de \SI{1}{\celsius} sa température (peu importe sa température initiale dans qu'il n'y a pas changement d'état).
...
\begin{enumerate}
	...
	\item Quels sont les deux manières pour un système de modifier son énergie internes ?
	...
	\item Donne la relation en la capacité thermique massique $c$, la masse, $\Delta T$ et Q pour un système incompressible.
\end{enumerate}
}
