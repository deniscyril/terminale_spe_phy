...
\etiquetterouge{Idée forte} En apportant de l'énergie électrique à un système chimique, il est possible de \trou{ renverser }le sens de l'évolution spontané d'une réaction chimique, c'est \textbf{\trou{l'électrolyse}}. L'énergie est apportée par un \textbf{générateur} qui va \textbf{\trou{imposer le sens }du courant} et donc celui des échanges d'électrons.
...
\newpage
\section{Application dépot d'un métal sur une surface}
...
\item En déduire la quantité d'électrons en mol devant traverse le circuit.
...
\item Constante d'Avogadro: $ N_{A}=6,02\times10^{23}mol^{-11}$
