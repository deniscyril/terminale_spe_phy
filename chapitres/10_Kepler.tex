...
On étudie le système Satellite (noté S) de masse $m$ situé à une distance $r$ du centre de la Terre (noté T) et de masse $M_T$. Le référentiel choisi est le référentiel: \trou{géocentrique} considéré galiléen.
...
On sait que la valeur de la force gravitationnelle subie par le Satellite vaut 
\begin{equation*}
...
Appliquons la seconde loi de Newton au système satellite:
\begin{eqnarray}
