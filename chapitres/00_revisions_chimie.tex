...
Tous les solides ioniques comme toute la matière en général sont neutres \trou{électriquement}. 
...
\begin{enumerate}
    ...
    \item A partir de $S_1$, on prépare une solution $S_2$ de volume $V_2=75,0$ mL et de concentration de $C_2=\SI{5.00e-3}{\mol\per\liter}$. Détailler le protocole expérimental qui conduit à l'élaboration de $S_2$. On fera la liste du matériel et des schémas clés.
\end{enumerate}
...
\\
Initialement les espèces présentes sont les réactifs: $C_3H_8$ et $O_2$. Celles qui apparaissent sont $CO_2$ et $H_2O$	
	
	\item Proposer une écriture de l'équation de la réaction.\\
...
Nous construisons un tableau d'avancement :\\
		\begin{center}
		\begin{tabular}{|l|c|c|c|c|}
\hline 
...
\end{center}
\begin{enumerate}
	\item On relève les quantités de matière initiales et on les place à la première ligne du tableau.
...
Equation chimique& Savoir équilibrer\\
 ...
 Mélange stoechiométrique&Justifier qu'un mélange initial est stoechiométrique
